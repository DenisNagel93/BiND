...
public class ParserTest {
    ...
    public static void testReadDataSet(File src,String delim) {
        DataSet d = LoadDataSets.loadDataSetsFromFile(src,delim);
    ...
    public static void testReadNarrative(File src,String delim) {
        Narrative n = LoadNarratives.loadNarrativeFromFile(src,delim);
